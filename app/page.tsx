      ...
      >
        ...
        <div style={{ position: "relative" }}>
          ...
          >
            ...
            <div style={{ color: "rgba(255,255,255,0.85)", fontSize: "12px" }}>
              Status: <span style={{ color: "rgba(255,255,255,0.65)" }}>Recovery Mode</span>
            </div>
          </div>
        </div>
        ...
        <div style={{ padding: "18px 18px 16px 18px" }}>
          ...
          <div style={{ marginTop: "14px", fontSize: "12px", color: "rgba(255,255,255,0.50)" }}>
            We’ll be back soon with faster, cleaner metrics and a more stable network.
          </div>
        </div>
      </div>
    </main>
...
export default function Page() {
  return (
    <Shell
      title="USDDD Scan is under maintenance"
      subtitle="We’re optimizing the network and stabilizing the data layer. Please check back soon."
    />
  );
}
